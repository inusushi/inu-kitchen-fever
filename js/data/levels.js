export const LEVELS = [
  {
    ...
    maxCustomers: 4, orderSizes: [1], starGoals: [280, 460, 650],
  },
  {
    ...
    maxCustomers: 4, orderSizes: [1], starGoals: [480, 800, 1100],
  },
  {
    ...
    maxCustomers: 5, orderSizes: [1, 1, 2], starGoals: [750, 1250, 1750],
  },
  {
    ...
    maxCustomers: 5, orderSizes: [1, 1, 2], starGoals: [640, 1050, 1500],
  },
  {
    ...
    maxCustomers: 5, orderSizes: [1, 2], starGoals: [670, 1100, 1550],
  },
  {
    ...
    maxCustomers: 5, orderSizes: [1, 2], starGoals: [770, 1250, 1800],
  },
  {
    id: 'rollosVip', name: 'Rollos VIP', emoji: '👑',
    recipeIds: ['musashiRoll', 'donKangrejo'],
    duration: 102000, spawnInterval: [2200, 3400], patience: 11000,
    maxCustomers: 6, orderSizes: [1, 2, 2], starGoals: [800, 1300, 1850],
  },
  {
    ...
    maxCustomers: 6, orderSizes: [1, 2, 2, 3], starGoals: [190, 310, 450],
  },
];
